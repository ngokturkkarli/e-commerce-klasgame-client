  ...
  return (
    <div className="hidden lg:block relative z-50">
      <input
        ...
        className="w-[400px] xl:w-[600px] h-12 px-4 outline-none border-2 border-white/20 rounded-2xl bg-transparent"
      />
      {isOpenBox && (
        <div className="absolute bg-stone-900 border border-white/20 w-[400px] xl:w-[600px] flex flex-col gap-2 mt-1 rounded-lg p-4">
